...
define(["editor/libs/ui"],function(UI){
	var UIElement = UI.UIElement;
	var UISpan = UI.UISpan;
	var UIDiv = UI.UIDiv;
	var UIRow = UI.UIRow;
	var UIButton = UI.UIButton;
	var UICheckbox = UI.UICheckbox;
	var UIText = UI.UIText;
	var UINumber = UI.UINumber;
	/**
	 * @author mrdoob / http://mrdoob.com/
	 */
