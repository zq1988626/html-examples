...
*/
define(["THREE","editor/libs/signals.min","editor/Strings","editor/Config"],function(
    THREE,signals,Strings,Config
){
    ...
    Editor.prototype = {
        ...
        execute: function ( cmd, optionalName ) {
            console.log("editor.execute:this.history.execute( cmd, optionalName );");
