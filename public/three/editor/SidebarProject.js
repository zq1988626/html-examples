...
*/
define(["THREE","editor/libs/ui","editor/libs/ui.three"],function(THREE,UI,THREEUI){
    var { UIPanel, UIRow, UIInput, UICheckbox, UIText, UIListbox, UISpan, UIButton, UISelect, UINumber }  = UI;
    var { UIBoolean } = THREEUI;
