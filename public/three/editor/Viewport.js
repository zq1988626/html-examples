...
define(["THREE","editor/libs/ui","editor/Viewport.Camera","editor/Viewport.Info","TransformControls"],function(
    THREE,UI,ViewportCamera,ViewportInfo,TransformControls
){
    var UIPanel = UI.UIPanel;
    var ViewportInfo = ViewportInfo.ViewportInfo;
    var ViewportCamera = ViewportCamera.ViewportCamera;
