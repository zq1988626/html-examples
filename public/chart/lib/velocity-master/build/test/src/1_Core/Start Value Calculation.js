...
QUnit.todo("Start Value Calculation", (assert) => {
    ...
    const testPropertiesEndNoConvert = { paddingLeft: "20px", height: "40px", paddingRight: "75%" }, $target3 = getTarget();
    ...
    const testPropertiesEndConvert = { paddingLeft: "20%", height: "40%", lineHeight: "0.5em", wordSpacing: "2rem", marginLeft: "10vw", marginTop: "5vh", marginBottom: "100px" }, parentWidth = $qunitStage.clientWidth, parentHeight = $qunitStage.clientHeight, parentFontSize = Velocity($qunitStage, "style", "fontSize"), remSize = parseFloat(Velocity(document.body, "style", "fontSize")), $target4 = getTarget();
