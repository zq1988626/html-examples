...
export function expandSequence(animation, sequence) {
 ...
 */
export function registerSequence(args) {
    if (isPlainObject(args[0])) {
        ...
        if (!isString(name)) {
            ...
            const percents = {}, steps = new Array(100), properties = [], percentages = [], sequenceList = SequencesObject[name] = {}, duration = validateDuration(sequence.duration);
            sequenceList.tweens = {};
