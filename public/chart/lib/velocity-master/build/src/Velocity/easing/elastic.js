...
// Constants
const PI2 = Math.PI * 2;
export function registerElasticIn(name, amplitude, period) {
...
export function registerElasticOut(name, amplitude, period) {
    registerEasing([name, (percentComplete, startValue, endValue) => {
            if (percentComplete === 0) {
                return startValue;
            }
...
export function registerElasticInOut(name, amplitude, period) {
    registerEasing([name, (percentComplete, startValue, endValue) => {
            if (percentComplete === 0) {
                return startValue;
            }
