...
import { constructorCache, constructors, NoCacheNormalizations, Normalizations, NormalizationUnits } from "./normalizationsObject";
/**
 ...
 * for performance!
 */
export function registerNormalization(args) {
 ...
 */
export function hasNormalization(args) {
 ...
 */
export function getNormalizationUnit(fn) {
 ...
 * more normalizations.
 */
export function getNormalization(element, propertyName) {
