 ...
 */
export function parseDuration(duration, def) {
 ...
 */
export function validateBegin(value) {
    if (isFunction(value)) {
        return value;
    }
    if (value != null) {
 ...
 */
export function validateComplete(value, noError) {
    if (isFunction(value)) {
        return value;
    }
 ...
 */
export function validateDuration(value, noError) {
    const parsed = parseDuration(value);
 ...
 */
export function validateEasing(value, duration, noError) {
    if (isString(value)) {
        // Named easing
 ...
 */
export function validateFpsLimit(value) {
    if (value === false) {
        return 0;
    }
    else {
 ...
 */
export function validateLoop(value) {
    switch (value) {
        case false:
            return 0;
        case true:
 ...
 */
export function validatePromise(value) {
    if (isBoolean(value)) {
        return value;
    }
    if (value != null) {
 ...
 */
export function validatePromiseRejectEmpty(value) {
    if (isBoolean(value)) {
        return value;
    }
    if (value != null) {
 ...
 */
export function validateQueue(value, noError) {
 ...
 */
export function validateRepeat(value) {
    switch (value) {
        case false:
            return 0;
        case true:
